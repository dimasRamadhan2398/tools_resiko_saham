...
if not ticker1:
    ...
    if data1.empty:
        ...
        return_kerugian = ((start_price - q) / start_price) * 100
        return_keuntungan = ((max_price - start_price) / max_price) * 100
        ...
        if ticker1.endswith('.JK'):
            if 1 < days <= 90:
                st.write(
                    ...
                    % (((start_price - q) * 100) * 0.2), "atau sekitar :red[-%.2f]%%" % (return_kerugian * 0.2),
                ...
                st.write(
                    ...
                    % (((max_price - start_price) * 100) * 0.1), "atau sekitar :green[%.2f]%%" % (return_keuntungan * 0.1))
            elif 91 < days <= 180:
                st.write(
                    "99% kemungkinan :red[resiko kerugian] yang bisa Anda alami dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    " untuk :blue[1 lot] nya adalah sebesar :red[-Rp.%.0f]"
                    % (((start_price - q) * 100) * 0.4), "atau sekitar :red[-%.2f]%%" % (return_kerugian * 0.4),
                    ", 1% kemungkinan :red[resiko kerugian] bisa lebih dari itu")
                st.write(
                    "Kemungkinan :green[keuntungan] yang bisa Anda dapat dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    "untuk :blue[1 lot] nya adalah sebesar :green[Rp.%.0f]"
                    % (((max_price - start_price) * 100) * 0.2), "atau sekitar :green[%.2f]%%" % (return_keuntungan * 0.2))
            elif 181 < days <= 270:
                st.write(
                    "99% kemungkinan :red[resiko kerugian] yang bisa Anda alami dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    " untuk :blue[1 lot] nya adalah sebesar :red[-Rp.%.0f]"
                    % (((start_price - q) * 100) * 0.7), "atau sekitar :red[-%.2f]%%" % (return_kerugian * 0.7),
                    ", 1% kemungkinan :red[resiko kerugian] bisa lebih dari itu")
                st.write(
                    "Kemungkinan :green[keuntungan] yang bisa Anda dapat dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    "untuk :blue[1 lot] nya adalah sebesar :green[Rp.%.0f]"
                    % (((max_price - start_price) * 100) * 0.3), "atau sekitar :green[%.2f]%%" % (return_keuntungan * 0.3))
            elif 271 < days <= 365:
                st.write(
                    "99% kemungkinan :red[resiko kerugian] yang bisa Anda alami dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    " untuk :blue[1 lot] nya adalah sebesar :red[-Rp.%.0f]"
                    % ((start_price - q) * 100), "atau sekitar :red[-%.2f]%%" % (return_kerugian),
                    ", 1% kemungkinan :red[resiko kerugian] bisa lebih dari itu")
                st.write(
                    "Kemungkinan :green[keuntungan] yang bisa Anda dapat dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
            ...
            if 0 < days <= 90:
                st.write(
                    ...
                    % (((start_price - q) * 16000) * 0.2), "atau sekitar :red[-%.2f]%%" % (return_kerugian * 0.2),
                ...
                st.write(
                    ...
                    % (((max_price - start_price) * 16000) * 0.1), "atau sekitar :green[%.2f]%%" % (return_keuntungan * 0.1),
                    "(kurs: Rp.16,000)")
            elif 91 < days <= 180:
                st.write(
                    "99% kemungkinan :red[resiko kerugian] yang bisa Anda alami dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    "untuk :blue[1 lembar] nya adalah sebesar :red[-Rp.%.0f]"
                    % (((start_price - q) * 16000) * 0.4), "atau sekitar :red[-%.2f]%%" % (return_kerugian * 0.4),
                    ", 1% kemungkinan :red[resiko kerugian] bisa lebih dari itu (kurs: Rp.16,000)"
                )
                st.write(
                    "Kemungkinan :green[keuntungan] yang bisa Anda dapat dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    "untuk :blue[1 lembar] nya adalah sebesar :green[Rp.%.0f]"
                    % (((max_price - start_price) * 16000) * 0.2), "atau sekitar :green[%.2f]%%" % (return_keuntungan * 0.2),
                    "(kurs: Rp.16,000)")
            elif 181 < days <= 270:
                st.write(
                    "99% kemungkinan :red[resiko kerugian] yang bisa Anda alami dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    "untuk :blue[1 lembar] nya adalah sebesar :red[-Rp.%.0f]"
                    % (((start_price - q) * 16000) * 0.7), "atau sekitar :red[-%.2f]%%" % (return_kerugian * 0.7),
                    ", 1% kemungkinan :red[resiko kerugian] bisa lebih dari itu (kurs: Rp.16,000)"
                )
                st.write(
                    "Kemungkinan :green[keuntungan] yang bisa Anda dapat dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    "untuk :blue[1 lembar] nya adalah sebesar :green[Rp.%.0f]"
                    % (((max_price - start_price) * 16000) * 0.3), "atau sekitar :green[%.2f]%%" % (return_keuntungan * 0.3),
                    "(kurs: Rp.16,000)")
            elif 271 < days <= 365:
                st.write(
                    "99% kemungkinan :red[resiko kerugian] yang bisa Anda alami dalam",
                    days, "hari kedepan jika Anda memilih saham", ticker1,
                    "untuk :blue[1 lembar] nya adalah sebesar :red[-Rp.%.0f]"
                    % ((start_price - q) * 16000), "atau sekitar :red[-%.2f]%%" % (return_kerugian),
                    ", 1% kemungkinan :red[resiko kerugian] bisa lebih dari itu (kurs: Rp.16,000)"
                )
                st.write(
                    "Kemungkinan :green[keuntungan] yang bisa Anda dapat dalam",
